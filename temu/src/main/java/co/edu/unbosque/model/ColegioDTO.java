...
/**
 * Clase DTO que representa un artículo de papelería para colegio. Extiende la
 * clase Papeleria e implementa Serializable.
 */
public class ColegioDTO extends Papeleria implements Serializable {
	...
	/**
	 * Representación en cadena de la instancia de ColegioDTO.
	 * 
