...
/**
 * Clase que representa ropa para mujer. Extiende la clase Ropa e implementa
 * Serializable.
 */
public class Mujer extends Ropa implements Serializable {
	 ...
	 * @param esConjunto Indica si la prenda es un conjunto.
	 */
	public Mujer(String nombre, int precio, String imagen, String talla, String color, String esConjunto) {
