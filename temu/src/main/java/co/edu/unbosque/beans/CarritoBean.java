...
public class CarritoBean implements Serializable {
    ...
    @Inject private EnvioCorreo envioCorreo;
    @Inject private LoginBean loginbean; // tomamos datos de sesión aquí

    // ======== Items / Total ========
    public List<ItemView> getItems() { return carritoService.listarItemsView(nombreCarrito); }
    public int getTotal() { return carritoService.total(nombreCarrito); }
    ...
    public void eliminarItem() {
        ...
        addMsg(ok ? FacesMessage.SEVERITY_INFO : FacesMessage.SEVERITY_ERROR,
               ok ? "Eliminado" : "Error",
    ...
    public String pagar() {
        ...
        if (correo == null || correo.isBlank()) {
            ...
            if (c instanceof String s && !s.isBlank()) correo = s;
        }
        ...
        try {
            ...
            if (d instanceof String s && !s.isBlank()) direccion = s;
        } catch (Exception ignored) {}
        if (direccion == null || direccion.isBlank()) direccion = "No registrada";
    ...
    private String buildEmailHtml(String direccionEnvio) {
        ...
        sb.append("<div style='font-family:Arial,Helvetica,sans-serif'>")
          .append("<h2>TEMU SHOP - Compra exitosa</h2>")
