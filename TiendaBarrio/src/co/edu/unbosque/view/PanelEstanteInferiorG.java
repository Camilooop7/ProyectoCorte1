...
/**
 * Panel que representa el estante inferior de gaseosas en la interfaz gráfica.
...
public class PanelEstanteInferiorG extends JPanel {
	...
	/**
	 * Constructor del panel del estante inferior de gaseosas. Configura el panel
	 ...
	 * mitad inferior de la lista de gaseosas.
	 *
