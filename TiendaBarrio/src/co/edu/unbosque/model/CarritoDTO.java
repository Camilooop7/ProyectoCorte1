...
/**
 * Clase DTO que representa un carrito de compras. Se utiliza para transferir
 * datos entre capas de la aplicación. Implementa Serializable para permitir la
...
public class CarritoDTO implements Serializable {
	...
	/**
	 * Constructor por defecto de la clase CarritoDTO. Inicializa la lista de
	 * nombres de productos como una lista enlazada vacía.
	 */
	public CarritoDTO() {
	...
	/**
	 * Agrega el nombre de un producto a la lista de nombres de productos del
	 * carrito.
	 *
