...
/**
 * Clase que representa una verdura, extendiendo la funcionalidad de Producto.
...
public class Verdura extends Producto implements Serializable {
	...
	/**
	 * Constructor por defecto de la clase Verdura.
	 */
	public Verdura() {
	 ...
	 */
	public Verdura(String forma, String tamano) {
		super();
		this.forma = forma;
		this.tamano = tamano;
	}
	 ...
	 * @param tamano El tamaño de la verdura.
	 */
	public Verdura(String nombre, int precio, String imagen, String forma, String tamano) {
	 ...
	 * @param imagen La ruta o nombre de la imagen asociada a la verdura.
	 */
	public Verdura(String nombre, int precio, String imagen) {
		super(nombre, precio, imagen);
		// TODO Auto-generated constructor stub
	}
