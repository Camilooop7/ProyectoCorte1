...
/**
 * Clase que representa una gaseosa, extendiendo la funcionalidad de  Bebida.
...
public class Gaseosa extends Bebida implements Serializable {
    ...
    /**
     * Constructor por defecto de la clase Gaseosa.
     */
    public Gaseosa() {
     ...
     *
     * @param esZero {@code true} si la gaseosa es zero, {@code false} en caso contrario.
     */
