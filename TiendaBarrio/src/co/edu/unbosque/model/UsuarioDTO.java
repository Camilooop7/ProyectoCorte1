...
/**
 * Clase DTO que representa un usuario del sistema. Implementa Serializable para
 * permitir la serialización de sus instancias.
 */
public class UsuarioDTO implements Serializable {
	...
	/**
	 * Constructor que inicializa el nombre, identificación y lista de carritos del
	 * usuario.
	 *
