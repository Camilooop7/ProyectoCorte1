...
public class ModelFacade {
    ...
    public LinkedList<String> crearStock(LinkedList<Verdura> a, LinkedList<Gaseosa> b, LinkedList<Jugo> e, LinkedList<Fruta> c, LinkedList<PaquetePapa> d) {
        if (a == null) a = new LinkedList<>();
        if (b == null) b = new LinkedList<>();
        if (e == null) e = new LinkedList<>();
        if (c == null) c = new LinkedList<>();
        if (d == null) d = new LinkedList<>();
