...
/**
 * Clase DTO que representa un jugo. Extiende la funcionalidad de Bebida e
...
public class JugoDTO extends Bebida implements Serializable {
	...
	/**
	 * Constructor por defecto de la clase JugoDTO.
	 */
	public JugoDTO() {
	 ...
	 *
	 * @param esNatural {@code true} si el jugo es natural, {@code false} en caso
	 *                  contrario.
	 */
